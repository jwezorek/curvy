...
namespace curvy {
    ...
    std::optional<double> circles_traveling_in_circles_collision_time(double r1, double theta1, double a1, double cx, double cy, double r2, double theta2, double a2, double d, double t2);
