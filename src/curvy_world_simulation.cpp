...
void curvy::curvy_world_simulation::handle_collision( collision& collision) {
    ...
    auto projection_a_to_b = curvy::project(
        a,
        curvy::curvy_vector(a_to_b_circle, a_to_b_orientation, 1.0),
        pt_a,
        pt_b,
        sz_constant
    );
    auto [b_to_a_circle, b_to_a_orientation] = curvy::circular_direction_through_two_points(pt_b, direction_b, pt_a);
    auto projection_b_to_a = curvy::project(
        b,
        curvy::curvy_vector(b_to_a_circle, b_to_a_orientation, 1.0),
        pt_b,
        pt_a,
        sz_constant
    );
